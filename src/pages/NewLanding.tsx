...
const handleSubscribe = (plan: string) => {
  if (!user) {
    navigate('/signup');  // Changed from '/auth'
    return;
  }
  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="grid md:grid-cols-3 gap-8">
      ...
      <div className="relative bg-white rounded-2xl overflow-hidden border border-gray-300 flex flex-col p-8 shadow-lg">
        ...
        <h3 className="text-3xl mt-16 font-bold text-pink-600 mb-1">Individual</h3>
        <div className="text-xl font-bold text-gray-900">₹199 for 2 months</div>
        <div className="text-sm text-gray-600 mb-6">₹199/month after</div>
        <ul className="mb-8 mt-2 text-gray-800 text-base space-y-3" style={{ minHeight: 110 }}>
          <li>3 extension slots per month</li>
        ...
        <button 
          onClick={() => {
            if (!user) {
              ...
              window.location.href = 'https://buy.stripe.com/test_7sY3co60y40D8pxdlQ8IU00';
            }
          }}
      ...
      <div className="relative bg-white rounded-2xl overflow-hidden border border-gray-300 flex flex-col p-8 shadow-lg">
        ...
        <h3 className="text-3xl mt-16 font-bold text-purple-600 mb-1">Developer</h3>
        <div className="text-xl font-bold text-gray-900">₹299 for 2 months</div>
        <div className="text-sm text-gray-600 mb-6">₹299/month after</div>
        <ul className="mb-8 mt-2 text-gray-800 text-base space-y-3" style={{ minHeight: 110 }}>
          <li>10 extension slots per month</li>
          <li>Advanced customization</li>
          <li>Live preview & export</li>
        ...
        <button 
          onClick={() => {
            if (!user) {
              ...
              // Replace with your Developer plan payment link
              window.location.href = 'YOUR_DEVELOPER_PLAN_STRIPE_LINK_HERE';
            }
          }}
      ...
      {/* Enterprise Plan */}
      <div className="relative bg-white rounded-2xl overflow-hidden border border-gray-300 flex flex-col p-8 shadow-lg">
        <span className="absolute left-7 top-7 px-4 py-1 rounded-md font-semibold bg-yellow-200 text-black text-base" style={{ letterSpacing: "0.02em" }}>
          ₹599 for 2 months
        </span>
        <h3 className="text-3xl mt-16 font-bold text-yellow-500 mb-1">Enterprise</h3>
        <div className="text-xl font-bold text-gray-900">₹599 for 2 months</div>
        <div className="text-sm text-gray-600 mb-6">₹599/month after</div>
        <ul className="mb-8 mt-2 text-gray-800 text-base space-y-3" style={{ minHeight: 110 }}>
          <li>Unlimited extension slots</li>
          <li>Team collaboration & API access</li>
        ...
        <button 
          onClick={() => {
            if (!user) {
              ...
              // Replace with your Enterprise plan payment link
              window.location.href = 'YOUR_ENTERPRISE_PLAN_STRIPE_LINK_HERE';
            }
          }}
          className="w-full py-4 rounded-full font-bold bg-yellow-200 text-black text-lg mt-auto mb-3 hover:bg-yellow-300 transition"
        >
          Try 2 months for ₹599
        </button>
        <button className="w-full py-4 rounded-full font-bold border-2 border-gray-300 text-gray-700 hover:bg-gray-100 transition">
          One-time payment
        </button>
      ...
      {/* Update App.tsx to remove onNavigate prop */}
      {/* Note: Also update the hero div to have proper min-h for home section if needed */}

      {/* Add some global styles for smooth scrolling if not present */}
      {/* But since in component, add to style tag or assume html { scroll-behavior: smooth; } */}
    </>
  );
};
